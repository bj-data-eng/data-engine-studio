...
pub use crate::{
    floating::{
        ...
        FloatingInline, FloatingOffset, FloatingOptions, FloatingOverflow, FloatingPadding,
        FloatingPlacement, FloatingPosition, FloatingRect, FloatingShift, FloatingShiftLimiter,
        FloatingSide, FloatingSize, FloatingVisibility,
    },
