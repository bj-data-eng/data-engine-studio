...
impl HtmlDocument {
    ...
    /// Creates a projected view, routes input, collects typed actions, and dispatches them.
    pub fn update_with_input_projection_and_dispatch<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        projection: &DocumentProjection,
    ...
    /// Creates a projected view, routes input, and dispatches only typed action values.
    ...
    /// Creates a projected view, configures typed actions, and dispatches action values.
    ...
    /// Builds projection in place, routes input, collects typed actions, and dispatches them.
    pub fn update_with_input_projected_with_and_dispatch<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        project: impl FnOnce(&mut DocumentProjection),
    ...
    /// Builds projection in place, routes input, and dispatches only typed action values.
    ...
    /// Builds projection in place, configures typed actions, and dispatches action values.
    ...
    /// Resolves this HTML tree and returns only typed Rust action values.
    ...
    /// Resolves this HTML tree and returns only values mapped by intent and command.
    ...
    /// Routes input through this HTML tree and dispatches only typed Rust action values.
    ...
    /// Routes input, configures typed actions, and dispatches only action values.
    ...
    /// Parses CSS, routes input, and dispatches only typed action values.
    pub fn update_with_input_and_css_and_dispatch_action_values<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        css: &str,
    ...
    /// Parses CSS, configures typed actions, and dispatches only action values.
    pub fn update_with_input_and_css_and_dispatch_action_values_with<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        css: &str,
        ...
        Action: Clone,
    {
        let mut registry = DocumentCommandRegistry::new();
        configure(&mut registry);
        self.update_with_input_and_css_and_dispatch_action_values(
    ...
    /// Parses forgiving CSS, routes input, and dispatches only typed action values.
    pub fn update_with_input_and_css_forgiving_and_dispatch_action_values<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        css: &str,
    ...
    /// Parses forgiving CSS, configures typed actions, and dispatches action values.
    pub fn update_with_input_and_css_forgiving_and_dispatch_action_values_with<Action>(
        &self,
        viewport: Size,
        input: DocumentInput,
        css: &str,
        ...
        Action: Clone,
    {
        let mut registry = DocumentCommandRegistry::new();
        configure(&mut registry);
        self.update_with_input_and_css_forgiving_and_dispatch_action_values(
            viewport, input, css, &registry, handler,
        )
    }
...
impl HtmlSet {
    ...
    /// Routes input through a named document and returns only typed action values.
    pub fn update_with_input_action_values_with_actions<Action, Command>(
        &self,
        name: &str,
        viewport: Size,
    ...
    {
        self.get(name)?
            .update_with_input_action_values_with_actions(viewport, input, actions)
    }
    ...
    /// Routes input through a named document and returns values mapped by intent and command.
    pub fn update_with_input_action_values_with_intent_actions<Action, Command>(
        &self,
        name: &str,
        viewport: Size,
    ...
    {
        self.get(name)?
            .update_with_input_action_values_with_intent_actions(viewport, input, actions)
    }
    ...
    /// Applies projection, routes input, collects typed actions, and dispatches them.
    pub fn update_with_input_projection_and_dispatch<Action>(
        &self,
        name: &str,
        viewport: Size,
    ...
    where
        Action: Clone,
    {
        self.get(name)?.update_with_input_projection_and_dispatch(
            viewport, input, projection, registry, handler,
        )
    }
    ...
    /// Parses CSS, configures typed actions, and dispatches action values.
    pub fn update_with_input_and_css_and_dispatch_action_values_with<Action>(
        &self,
        name: &str,
        viewport: Size,
